...
int GuiTextBox(Rectangle bounds, char *text, int textSize, bool editMode)
{
        ...
        #define RAYGUI_TEXTBOX_AUTO_CURSOR_COOLDOWN  120        // Frames to wait for autocursor movement
    #endif
    #if !defined(RAYGUI_TEXTBOX_AUTO_CURSOR_DELAY)
        #define RAYGUI_TEXTBOX_AUTO_CURSOR_DELAY     6        // Frames delay for autocursor movement
    #endif
